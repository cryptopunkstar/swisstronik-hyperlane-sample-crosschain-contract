...
const AMOY_MERKLE_TREE_HOOK = "0xddf4C3e791caCaFd26D7fb275549739B38ae6e75";
const AMOY_MAILBOX = "0x54148470292C24345fb828B003461a9444414517";
const AMOY_ISM = "0x12ecb319c7f4e8ac5eb5226662aeb8528c5cefac";
...
async function main() {
  ...
  const amoyContractAddress = await AMOY_ISMContract.getAddress();
